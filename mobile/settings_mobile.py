...
from settings import (
    ...
    MUSIC_FILE, UPGRADES, ACHIEVEMENTS, OFFLINE_INCOME_CAP, POPUP_LIFETIME, POPUP_SPEED, MAX_CLICKS_PER_SEC, REBIRTH_BASE_COST, COIN_ANIM_SPEED, COIN_BASE_RADIUS, COIN_GLOW_RADIUS,
)